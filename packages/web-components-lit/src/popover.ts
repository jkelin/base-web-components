import { P, LightLitElement, nextId, define, TextButton, OpenRoot } from "./shared";

export class LitPopoverElement extends OpenRoot {
...
export class LitPopoverTriggerElement extends TextButton {
  override marker = "popover-trigger";
}
export class LitPopoverCloseElement extends TextButton {
  override marker = "popover-close";
}
export class LitPopoverPopupElement extends LightLitElement {}

const definitions: [string, CustomElementConstructor][] = [
  ["lit-popover", LitPopoverElement],
  ["lit-popover-trigger", LitPopoverTriggerElement],
  ["lit-popover-popup", LitPopoverPopupElement],
  ["lit-popover-close", LitPopoverCloseElement],
];
