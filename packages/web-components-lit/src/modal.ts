import { P, LightLitElement, nextId, markerClass, define, TextButton, OpenRoot } from "./shared";

export class LitModalElement extends OpenRoot {
  ...
  override sync() {
    ...
    const popup = this.querySelector(`${P}-modal-popup`) as LitModalPopupElement | null;
...
export class LitModalTriggerElement extends TextButton {
  override marker = "modal-trigger";
}
export class LitModalCloseElement extends TextButton {
  override marker = "modal-close";
}
export class LitModalPopupElement extends LightLitElement {
...
const definitions: [string, CustomElementConstructor][] = [
  ["lit-modal", LitModalElement],
  ["lit-modal-trigger", LitModalTriggerElement],
  ["lit-modal-popup", LitModalPopupElement],
  ["lit-modal-close", LitModalCloseElement],
];
