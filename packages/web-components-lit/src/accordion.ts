...
export class LitAccordionElement extends ObservedRoot {
  static override observedAttributes = ["value", "multiple", "disabled"];
  #value: string[] = [];
  #controlled = false;
  #initialized = false;
  get value() {
...
export class LitAccordionItemElement extends LightLitElement {}
export class LitAccordionTriggerElement extends TextButton {
  override marker = "accordion-trigger";
}
export class LitAccordionPanelElement extends LightLitElement {}

const definitions: [string, CustomElementConstructor][] = [
  ["lit-accordion", LitAccordionElement],
  ["lit-accordion-item", LitAccordionItemElement],
  ["lit-accordion-trigger", LitAccordionTriggerElement],
  ["lit-accordion-panel", LitAccordionPanelElement],
];
