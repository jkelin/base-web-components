...
export const O_TOGGLE_CHECKBOX_TAG = "o-toggle-checkbox";
export class OptimizedToggleCheckboxElement extends HTMLElement {
...
const definitions: Array<[string, CustomElementConstructor]> = [
  [O_TOGGLE_CHECKBOX_TAG, OptimizedToggleCheckboxElement],
];
