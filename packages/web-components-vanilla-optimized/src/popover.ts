...
export const O_POPOVER_TAG = "o-popover";
export const O_POPOVER_TRIGGER_TAG = "o-popover-trigger";
export const O_POPOVER_POPUP_TAG = "o-popover-popup";
export const O_POPOVER_CLOSE_TAG = "o-popover-close";
export class OptimizedPopoverTriggerElement extends ControlLeaf {
  static override marker = "popover-trigger";
}
export class OptimizedPopoverCloseElement extends ControlLeaf {
  static override marker = "popover-close";
}
export class OptimizedPopoverPopupElement extends ControlLeaf {
  static override marker = "popover-popup";
  static override kind = "div" as const;
}

export class OptimizedPopoverElement extends OpenController {
  ...
  #onClick = (event: Event) => {
    ...
    if (target.closest(`${O_POPOVER_TRIGGER_TAG} > button`)) this.requestOpen(!this.openState);
    if (target.closest(`${O_POPOVER_CLOSE_TAG} > button`)) this.requestOpen(false);
  };
  ...
  protected sync(): void {
    this.initializeOpen();
    this.#trigger = this.querySelector(`${O_POPOVER_TRIGGER_TAG} > button`);
    this.#popup = this.querySelector(`${O_POPOVER_POPUP_TAG} > div`);
    ...
    popupHost.id ||= nextId(O_POPOVER_POPUP_TAG);
...
const definitions: Array<[string, CustomElementConstructor]> = [
  [O_POPOVER_TAG, OptimizedPopoverElement],
  [O_POPOVER_TRIGGER_TAG, OptimizedPopoverTriggerElement],
  [O_POPOVER_POPUP_TAG, OptimizedPopoverPopupElement],
  [O_POPOVER_CLOSE_TAG, OptimizedPopoverCloseElement],
];
