...
export class PreactTabsElement extends ObservedRoot {
  static observedAttributes = ["value", "orientation", "activation-mode", "disabled"];
  #value = "";
  #controlled = false;
  #initialized = false;
  get value() {
...
export class PreactTabsListElement extends HTMLElement {}
export class PreactTabElement extends TextButton {
  override marker = "tab";
}
export class PreactTabPanelElement extends HTMLElement {}

const definitions: [string, CustomElementConstructor][] = [
  ["preact-tabs", PreactTabsElement],
  ["preact-tabs-list", PreactTabsListElement],
  ["preact-tab", PreactTabElement],
  ["preact-tab-panel", PreactTabPanelElement],
];
