import { h, render, bool, emit, markerClass, define } from "./shared";

export class PreactOtpFieldElement extends HTMLElement {
  ...
  sync() {
    ...
    const children: any[] = Array.from({ length }, (_, index) =>
      h("input", {
...
const definitions: [string, CustomElementConstructor][] = [
  ["preact-otp-field", PreactOtpFieldElement],
];
