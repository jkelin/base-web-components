import { P, nextId, bool, emit, define, ObservedRoot, TextButton } from "./shared";

export class PreactAccordionElement extends ObservedRoot {
...
export class PreactAccordionItemElement extends HTMLElement {}
export class PreactAccordionTriggerElement extends TextButton {
  override marker = "accordion-trigger";
}
export class PreactAccordionPanelElement extends HTMLElement {}

const definitions: [string, CustomElementConstructor][] = [
  ["preact-accordion", PreactAccordionElement],
  ["preact-accordion-item", PreactAccordionItemElement],
  ["preact-accordion-trigger", PreactAccordionTriggerElement],
  ["preact-accordion-panel", PreactAccordionPanelElement],
];
