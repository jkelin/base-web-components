import { P, nextId, define, TextButton, OpenRoot } from "./shared";

export class PreactPopoverElement extends OpenRoot {
...
export class PreactPopoverTriggerElement extends TextButton {
  override marker = "popover-trigger";
}
export class PreactPopoverCloseElement extends TextButton {
  override marker = "popover-close";
}
export class PreactPopoverPopupElement extends HTMLElement {}

const definitions: [string, CustomElementConstructor][] = [
  ["preact-popover", PreactPopoverElement],
  ["preact-popover-trigger", PreactPopoverTriggerElement],
  ["preact-popover-popup", PreactPopoverPopupElement],
  ["preact-popover-close", PreactPopoverCloseElement],
];
