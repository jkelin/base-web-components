...
export class SvelteTabsElement extends ObservedRoot {
...
export class SvelteTabsListElement extends LightElement {}
export class SvelteTabElement extends TextButton {
  override marker = "tab";
}
export class SvelteTabPanelElement extends LightElement {}
