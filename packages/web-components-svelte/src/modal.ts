import { P, LightElement, nextId, markerClass, TextButton, OpenRoot } from "./shared";

export class SvelteModalElement extends OpenRoot {
  ...
  override sync() {
    ...
    const popup = this.querySelector(`${P}-modal-popup`) as SvelteModalPopupElement | null;
...
export class SvelteModalTriggerElement extends TextButton {
  override marker = "modal-trigger";
}
export class SvelteModalCloseElement extends TextButton {
  override marker = "modal-close";
}
export class SvelteModalPopupElement extends LightElement {
