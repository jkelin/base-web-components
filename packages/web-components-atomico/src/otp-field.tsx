...
export const ATOMICO_OTP_FIELD_TAG = "atomico-otp-field";
type ValidationType = "numeric" | "alpha" | "alphanumeric" | "none";
export class AtomicoOtpFieldElement extends HTMLElement {
...
export const otpFieldDefinitions: ReadonlyArray<readonly [string, CustomElementConstructor]> = [
  [ATOMICO_OTP_FIELD_TAG, AtomicoOtpFieldElement],
];
