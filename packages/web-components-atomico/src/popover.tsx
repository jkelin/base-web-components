...
export const ATOMICO_POPOVER_TAG = "atomico-popover";
export const ATOMICO_POPOVER_TRIGGER_TAG = "atomico-popover-trigger";
export const ATOMICO_POPOVER_POPUP_TAG = "atomico-popover-popup";
export const ATOMICO_POPOVER_CLOSE_TAG = "atomico-popover-close";
export class AtomicoPopoverTriggerElement extends ControlLeaf {
  static override marker = "popover-trigger";
}
export class AtomicoPopoverCloseElement extends ControlLeaf {
  static override marker = "popover-close";
}
export class AtomicoPopoverPopupElement extends ControlLeaf {
  static override marker = "popover-popup";
  static override kind = "div" as const;
}

export class AtomicoPopoverElement extends OpenController {
  ...
  #onClick = (event: Event) => {
    ...
    if (target.closest(`${ATOMICO_POPOVER_TRIGGER_TAG} > button`))
      this.requestOpen(!this.openState);
    if (target.closest(`${ATOMICO_POPOVER_CLOSE_TAG} > button`)) this.requestOpen(false);
  };
  ...
  protected sync(): void {
    this.initializeOpen();
    this.#trigger = this.querySelector(`${ATOMICO_POPOVER_TRIGGER_TAG} > button`);
    this.#popup = this.querySelector(`${ATOMICO_POPOVER_POPUP_TAG} > div`);
    ...
    popupHost.id ||= nextId(ATOMICO_POPOVER_POPUP_TAG);
...
export const popoverDefinitions: ReadonlyArray<readonly [string, CustomElementConstructor]> = [
  [ATOMICO_POPOVER_TAG, AtomicoPopoverElement],
  [ATOMICO_POPOVER_TRIGGER_TAG, AtomicoPopoverTriggerElement],
  [ATOMICO_POPOVER_POPUP_TAG, AtomicoPopoverPopupElement],
  [ATOMICO_POPOVER_CLOSE_TAG, AtomicoPopoverCloseElement],
];
