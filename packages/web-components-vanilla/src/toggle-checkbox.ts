...
export const VANILLA_TOGGLE_CHECKBOX_TAG = "vanilla-toggle-checkbox";
export class VanillaToggleCheckboxElement extends HTMLElement {
...
const definitions: Array<[string, CustomElementConstructor]> = [
  [VANILLA_TOGGLE_CHECKBOX_TAG, VanillaToggleCheckboxElement],
];
