...
export const VANILLA_OTP_FIELD_TAG = "vanilla-otp-field";
type ValidationType = "numeric" | "alpha" | "alphanumeric" | "none";
export class VanillaOtpFieldElement extends HTMLElement {
...
const definitions: Array<[string, CustomElementConstructor]> = [
  [VANILLA_OTP_FIELD_TAG, VanillaOtpFieldElement],
];
